...
{
    public class InsertarUsuarioDAL
    {
        public static int Execute(string usuarioNombre, string usuarioNombreRed, string rolesComas)
        {
            ...
            dynamicParameters.Add("@CodigosRoles", rolesComas, System.Data.DbType.String);
            ...
            int resultado = coneccion.Ejecutar<int>("PA_CRE_INSERTAR_USUARIO", dynamicParameters);
            return resultado;
        }                
    }
}
