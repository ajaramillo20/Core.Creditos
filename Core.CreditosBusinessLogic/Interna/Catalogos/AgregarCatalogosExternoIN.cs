...
{
    public class AgregarCatalogosExternoIN : IInsertar<CatalogoTrx, AgregarCatalogoResponse>
    {
        ...
        {
            InsertarInformacionCatalogoBLL.InsertarCatalogoExterno(objetoTransaccional);   
        }
