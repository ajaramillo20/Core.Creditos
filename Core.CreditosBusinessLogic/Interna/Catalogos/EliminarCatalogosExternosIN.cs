...
{
    public class EliminarCatalogosExternosIN : IEliminar<CatalogoTrx, EliminarCatalogoResponse>
    {
        ...
        {
            EliminarInformacionCatalogosBLL.EliminarCatalogoExterno(objetoTransaccional);
        }
