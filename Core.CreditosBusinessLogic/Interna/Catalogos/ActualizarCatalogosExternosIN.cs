...
{
    public class ActualizarCatalogosExternosIN : IActualizar<CatalogoTrx, ActualizarCatalogoResponse>
    {
        public void ActualizarInformacion(CatalogoTrx objetoTransaccional)
        {
            ActualizarInformacionCatalogosBLL.ActualizarCatalogoExterno(objetoTransaccional);
        }
