...
{
    public class EliminarParametroEvaluacionIN : IEliminar<ReglaNegocioTrx, ReglaNegocioResponse>
    {
        ...
        {
            ReglasNegocioEliminarInformacionBLL.EliminarParametroEvaluacion(objetoTransaccional.CodigoParametroEliminar);
        }
